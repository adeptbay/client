...
export const sampleDocument = (): CvDocument => ({
  ...
  email: 'muntasir.ahmed@example.com',
  phone: '+880 1712 345678',
  location: 'Dhaka, Bangladesh',
  links: [
    { label: 'Portfolio', url: 'muntasirahmed.dev' },
    { label: 'GitHub', url: 'github.com/muntasir3301' },
    { label: 'LinkedIn', url: 'linkedin.com/in/muntasir-ahmed-fahim' },
  ],
  objective:
